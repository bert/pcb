...
#define	MIN_PINORVIASIZE	MM_TO_COORD(0.02)	/* size of a pin or via */
#define	MIN_PINORVIAHOLE	MM_TO_COORD(0.01)	/* size of a pins or vias drilling hole */
#define	MAX_PINORVIASIZE	LARGE_VALUE
#define	MIN_PINORVIACOPPER	MM_TO_COORD(0.01)	/* min difference outer-inner diameter */
#define	MIN_PADSIZE		MM_TO_COORD(0.02)	/* min size of a pad */
