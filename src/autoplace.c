...
ComputeCost (NetListType *Nets, double T0, double T)
{
  ...
  /* now compute penalty function Wc which is proportional to amount
   * of overlap and congestion. delta1 is congestion penalty function */
