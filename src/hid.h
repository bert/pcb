...
extern "C"
{
   ...
   * \brief hidval
   * \par
   *  The HID may need something more than an "int" for colors,
   *  timers, etc.
   *
...
{ hid_register_actions(a, sizeof(a)/sizeof(a[0])); }
  ...
  /*!
   * \brief hid_parse_actions
   * \par
   *  Parse the given string into action calls, and call hid_actionv
...
{ hid_register_flags(a, sizeof(a)/sizeof(a[0])); }
  ...
  /*!
   * \brief hid_get_flag
   * \par Looks up one of the flags registered above.
   *
