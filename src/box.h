 ...
 *
 *  Contributing Author: C. Scott Ananian
 *  Date Contributed: 2001
 */
...
/*!
 * \brief Construct a minimum box that touches the input box at the center.
 */
static inline BoxType
...
/*!
 * \brief Construct a minimum box that touches the input box at the corner.
 */
static inline BoxType
