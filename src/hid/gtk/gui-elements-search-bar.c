...
/* The GhidElementsSearchBar GObject properties */
static GParamSpec *obj_properties[N_PROPERTIES] = { NULL, };

/* GhidElementsSearchBar property getter */
...
/* GhidElementsSearchBarClass initialiser */
static void ghid_elements_search_bar_class_init(GhidElementsSearchBarClass *klass)
{
...
static void search_icon_clicked( GtkEntry *entry,
...
/* Callback for when the regex option is toggled in the search menu */
static void regex_toggled( GtkCheckMenuItem *item,
			   gpointer _self )
{
	GhidElementsSearchBar *self = GHID_ELEMENTS_SEARCH_BAR(_self);

	g_object_notify_by_pspec( G_OBJECT(self),
				  obj_properties[PROP_REGEX] );
}

/* Callback for when case sensitivity is toggled in the search menu */
static void case_toggled( GtkCheckMenuItem *item,
			  gpointer _self )
{
	GhidElementsSearchBar *self = GHID_ELEMENTS_SEARCH_BAR(_self);
...
static void text_change_cb( GtkEditable *entry,
			    gpointer _ud )
{
...
/* GhidElementsSearchBar initialiser */
static void ghid_elements_search_bar_init(GhidElementsSearchBar *self)
{
...
/** Create a new GhidElementsSearchBar.
