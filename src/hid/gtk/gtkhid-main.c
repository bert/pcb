 ...
 *
 * Any action that always requires a point should have the need_coord_msg
 * field set to a message to be used when prompting the user for that point.
 * A call to this function is not required to obtain a coordinate for these
 ...
 * set to NULL.
 *
 * GetXY() exists *only* to request a point for actions that do not always
 ...
 *
 * It is not possible to use multiple GetXY() calls in a single action sequence
