...
bool
ghid_port_key_release_cb (GtkWidget *drawing_area, GdkEventKey *kev, void *data)
{
  int ksym = kev->keyval;
...
bool
ghid_port_key_press_cb (GtkWidget *drawing_area, GdkEventKey *kev, void *data)
{
...
bool
ghid_port_button_press_cb (GtkWidget *drawing_area, GdkEventButton *ev, void *data)
{
  ModifierKeysState mk;
  GdkModifierType state;
...
bool
ghid_port_button_release_cb (GtkWidget *drawing_area, GdkEventButton *ev, void *data)
{
  ModifierKeysState mk;
  GdkModifierType state;
...
static int check_object_tooltips (GHidPort *out)
{
  char *description;
