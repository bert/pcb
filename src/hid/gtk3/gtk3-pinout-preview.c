/*!
 * \file src/hid/gtk3/gtk3-pinout-preview.c
 *
...
/*!
 * \brief Just define a sensible scale, lets say (for example),
 * 100 pixel per 150 mil.
 */
 ...
 */
static void
ghid_pinout_preview_set_property (GObject *object, guint property_id, const GValue *value, GParamSpec * pspec)
{
  GhidPinoutPreview *pinout = GHID_PINOUT_PREVIEW (object);
 ...
 */
static void
ghid_pinout_preview_get_property (GObject *object, guint property_id, GValue *value, GParamSpec *pspec)
{
  switch (property_id)
  {
    default:
...
ghid_pinout_preview_get_type ()
{
  ...
  if (!ghid_pinout_preview_type)
  {
    static const GTypeInfo ghid_pinout_preview_info =
    {
      ...
      ghid_pinout_preview_type = g_type_register_static (GTK_TYPE_DRAWING_AREA,
                                                         "GhidPinoutPreview",
                                                         &ghid_pinout_preview_info,
                                                         (GTypeFlags) 0);
    }
 ...
 */
void
ghid_pinout_preview_get_natural_size (GhidPinoutPreview *pinout, int *width, int *height)
{
