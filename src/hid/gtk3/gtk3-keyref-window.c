/*!
 * \file src/hid/gtk3/gtk3-keyref-window.c
 *
 * \brief Provides a keyref window for the GTK3 UI.
 *
 ...
 */
static gint
keyref_window_configure_event_cb (GtkWidget * widget, GdkEventConfigure * ev, gpointer data)
{
