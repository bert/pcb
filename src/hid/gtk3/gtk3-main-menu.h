/*!
 * \file src/hid/gtk3/gtk3-main-menu.h
 *
 * \brief .
 *
...
#ifndef PCB_SRC_HID_GTK3_GTK3_MAIN_MENU_H__
#define PCB_SRC_HID_GTK3_GTK3_MAIN_MENU_H__
...
#endif /* PCB_SRC_HID_GTK3_GTK3_MAIN_MENU_H__ */
