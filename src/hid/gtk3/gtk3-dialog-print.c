/*!
 * \file src/hid/gtk3/gtk3-dialog-print.c
 *
 * \brief Provide a print dialog for the GTK3 GUI.
 *
  ...
  for (j = 0; j < n_attrs; j++)
  {
    ...
    switch (attrs[j].type)
    {
      ...
      case HID_Integer:
        ...
        /*! 
         * \todo Need to pick the "digits" argument based on min/max
         * values.
        */
      ...
      case HID_Real:
        ...
        /*! \todo Need to pick the "digits" and step size argument more
         * intelligently.
         */
        ghid_spin_button (hbox, &widget, attrs[j].default_val.real_value,
                          attrs[j].min_val, attrs[j].max_val,
                          0.01, 0.01,
                          3, 0, 
