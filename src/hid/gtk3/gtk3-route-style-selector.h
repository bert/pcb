/*!
 * \file src/hid/gtk3/gtk3-route-style-selector.h
 *
 * \brief .
 *
...
#ifndef PCB_SRC_HID_GTK3_GTK3_ROUTE_STYLE_SELECTOR_H__
#define PCB_SRC_HID_GTK3_GTK3_ROUTE_STYLE_SELECTOR_H__
...
void ghid_route_style_selector_sync (GHidRouteStyleSelector *rss, Coord Thick, Coord Hole, Coord Diameter, Coord Keepaway, Coord ViaMask);
void ghid_route_style_selector_empty (GHidRouteStyleSelector *rss);


G_END_DECLS  /* Keep C++ happy. */

#endif /* PCB_SRC_HID_GTK3_GTK3_ROUTE_STYLE_SELECTOR_H__ */
