/*!
 * \file src/hid/lessgtk/gui-top-window.c
 *
...
/* %start-doc options "23 lessGTK+ GUI Options"
@ftable @code
@item --listen
...
File name of an image to put into the background of the GUI canvas.
The image must be a color PPM image, in binary (not ASCII) format.
It can be any size, and will be automatically scaled to fit the canvas.
@end ftable
%end-doc
*/
...
Location of the @file{gpcb-menu.res} file which defines the menu for the
lessGTK+ GUI.
@end ftable
%end-doc
*/
