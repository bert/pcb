...
} FlagFuncList[] =
{
  ...
  {
  "alldirectionlines", FlagSETTINGS, XtOffsetOf (SettingType,
						   AllDirectionLines)},
  {
  ...
  {
  "resetafterelement", FlagSETTINGS, XtOffsetOf (SettingType,
						   ResetAfterElement)},
  {
  "ringbellwhenfinished", FlagSETTINGS, XtOffsetOf (SettingType,
  ...
  {
  "swapstartdirection", FlagSETTINGS, XtOffsetOf (SettingType,
						    SwapStartDirection)},
  {
