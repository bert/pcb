Element(0x00 "Header connector with latches" "" "DIN41651_16" 400 250 3 200 0x00)
(
	...
	Pin(180 1430 100 80 "M2" 0x01)
	# aeusserer Rahmen
	ElementLine(80 70 335 70 20)
	ElementLine(335 70 770 200 20)
	ElementLine(770 200 770 300 20)
	ElementLine(770 300 610 390 20)
	ElementLine(610 390 610 1350 20)
	ElementLine(610 1350 770 1400 20)
	ElementLine(770 1400 770 1500 20)
	ElementLine(770 1500 335 1630 20)
	ElementLine(335 1630 80 1630 20)
	ElementLine( 80 1630 80 70 20)
	# Codieraussparung
	ElementLine(610 775 435 775 5)
	ElementLine(435 775 435 925 5)
	ElementLine(435 925 610 925 5)
	# Markierung Pin 1
