Element(0x00 "Axial polar component (typically capacitor)," "" "ACY300P" 245 70 0 100 0x00)
(
	...
	ElementLine(0 -52 0 -12 10)
	ElementLine(-20 -32 20 -32 10)
	ElementLine(280 -32 320 -32 10)
