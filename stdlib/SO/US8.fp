...
Element[0x00000000 "Ultra (Micro?) Small outline package" "" "US8" 0 0 -2000 -6000 0 100 0x00000000]
(
# 
# Pad[x1, y1, x2, y2, thickness, clearance, mask, name , pad number, flags]
	...
	ElementLine[-7692 -4543 -7692  4543 1000]
	ElementLine[-7692  4543  7692  4543 1000]
	ElementLine[ 7692  4543  7692 -4543 1000]
	ElementLine[-7692 -4543 -2500 -4543 1000]
	ElementLine[ 7692 -4543  2500 -4543 1000]
	# punt on the arc on small parts as it can cover the pads
	ElementArc[0 -4543 2500 2500 0 180 1000]
)
