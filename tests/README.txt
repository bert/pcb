...
where <new_test_name> is the name of your new test from tests.list. If
you are adding multiple tests, then you can list them all on the same
command line.
...
Update inputs/Makefile_insert to include your new file.
